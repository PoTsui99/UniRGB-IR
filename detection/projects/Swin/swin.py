"""
Implementation of Swin Transformer for MM framework with detectron2 compatibility.

This code combines the implementation from detectron2's Swin Transformer 
with mmdetection's BaseModule for MM compatibility.
"""
...
class SwinTransformer(BaseModule):
    ...
    def init_weights(self):
        ...
        # Use base module init if not specified in init_cfg
        if getattr(self, 'init_cfg', None) is None:
