...
class CocoMetric(BaseMetric):  # 实质上就是利用 COCO 接口产生评估结果, 也可以只进行格式化, 将预测结果转换成特定格式, 核心是实现 process 和 compute_metrics
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        if self._coco_api is None:
            ...
            coco_json_path = self.gt_to_coco_json(  # Convert ground truth to coco format json file.
