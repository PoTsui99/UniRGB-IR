    ...
    def _prepare(self, id_setup):
        ...
        for gt in gts:
            ...
            gt['ignore'] = 1 if (gt['height'] < self.params.HtRng[id_setup][0] or gt['height'] >
                                 self.params.HtRng[id_setup][1]) else gt['ignore']
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.VisRng = [[0.65, 1e5 ** 2], [0.65, 1e5 ** 2], [0.65, 1e5 ** 2], [0.65, 1e5 ** 2],[0.65, 1e5 ** 2]]
        self.SetupLbl = ['Reasonable', 'scale-near','scale-medium', 'scale-far', 'All']
