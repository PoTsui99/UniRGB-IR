...
# by tsuipo, 23.10.30
# from .rgbt_salient import VTDataset
# by tsuipo, 24.1.30
from .mfnet import MFNetRGBADataset
from .pst900 import PST900RGBADataset

# by tsuipo, 24.3.24
from .rgbt_sod import VTDataset
...
__all__ = [
    ...
    'NYUDataset', 'VTDataset', 'MFNetRGBADataset', 'PST900RGBADataset'
]
